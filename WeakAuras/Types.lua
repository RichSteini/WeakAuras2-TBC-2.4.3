...
LSM:Register("font", "Expressway", [[Interface\AddOns\WeakAuras\Media\Fonts\Expressway.ttf]], LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_western)
...
Private.item_slot_types = {
  ...
  [9]  = WRISTSLOT,
  [10] = HANDSSLOT,
  [11] = FINGER0SLOT .. " 1", --_UNIQUE,
  [12] = FINGER1SLOT .. " 2", --_UNIQUE,
  [13] = TRINKET0SLOT .. " 1", --_UNIQUE,
  [14] = TRINKET1SLOT .. " 2", --_UNIQUE,
  [15] = BACKSLOT,
  [16] = MAINHANDSLOT,
