...
function OptionsPrivate.ConfirmDelete(toDelete, parents)
  if toDelete then
    ...
    local dialog = StaticPopup_Show("WEAKAURAS_CONFIRM_DELETE")
    dialog.data = {toDelete = toDelete, parents = parents}
  end
end
